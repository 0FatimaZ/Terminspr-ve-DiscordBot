...
room = {
    ...
    "Just my bed, some clothes and trash here and there, scattered arround in the room."],
    ...
    "room_3" : ["*The kitchen*",
    "My kitchen could be in a better condition.",
...
"-", 
"!investigate lets you further investigate whatever is in your chosen direction. ", 
"Like !walk, to choose direction, type either n, w, e or s after typing the control. ", 
"Remeber that you may have to walk closer to whatever it is you want to investigate, before you can investigate it. ", 
"-", 
...
def move_from_room_0(direction):
    if direction == "e": 
        ...
        if things_to_find["note1"] == True:
            ...
            return ["Just my shower.", "Nothing noticeably weird.", "Wait...", "Now that I'm actually looking.", "Theres something stuck on the wall..."]
    elif direction == "n":
    ...
    if walk_over_to["fridge"] == True:
        ...
        if direction == "w": 
            ...
            if things_to_find["note2"] == False:
                ...
                reply = ["What's that stain?...", "Hold up...", "Is that a stickynote?", "I grab the stickynote off the wall.", "It says 'DID YOU LIKE THE MEAL I PREPARED FOR YOU? ^_^'.", "The stickynote is covered in a gooey matter. The smell is indescribeable.", "I feel like throwing up."]
                if things_to_find["guts"] == True:
                    reply.append ("Again.")
                return (reply)
            else:
                return ["Over there is the wall where that creepy note was."]
        elif direction == "e":
            if things_to_find["guts"] == True:
...
def investigate_room_0(direction):
    if direction == "s":
        ...
        return ["Theres nothing special or noticeable in that direction."]
    ...
    if walk_over_to["fridge"] == True:
        if direction == "e":
            if things_to_find["guts"] == True:
                ...
                state["things"] += 1
                return ["I open the fridge without a second thought, only to be met by the most awful smell imaginable.", "The botton drawer of my fridge is practically drowning in an unidentifiable matter.", "The only word I can think of to describe what I am seeing, is gruesome...", "I threw up in the trash.", "I feel awful."]
        else:
            if things_to_find["guts"] == True:
    ...
    if not (message.author.bot):
        ...
        if contents.startswith("!quit"):
            ...
            if contents.startswith("!y"):
                ...
                await message.channel.send("If you want to see the control descriptions again, then you can simply at any point in the game, type !help.")
